/* out_of_order.c - test that modifications can be made to regions 
   in an order other than that in which the respective calls to
   about_to_modify() were made, and also that multiple calls to about_to_modify()
   can be made before any actual modifications are made. */
